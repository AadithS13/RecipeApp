...
public class EggCurry extends AppCompatActivity {
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(ed1.getText().toString().length() == 0)
                {
                    ...
                    Toast.makeText(EggCurry.this, "We have receive your query , our chef will get back to you ASAP !", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
