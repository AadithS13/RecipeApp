...
public class Eggcurry1 extends AppCompatActivity {

    ViewFlipper v_flipper;
    ViewPager vp,vp2,vp3;
    MyadapterE1 myadapter;
    MyadapterE2 myadapter2;
    MyadapterE3 myadapter3;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eggcurry1);

        int images[]={R.drawable.pb8,R.drawable.pb7};

        v_flipper=findViewById(R.id.flipper);
        myadapter=new MyadapterE1(this);
        myadapter2=new MyadapterE2(this);
        myadapter3=new MyadapterE3(this);
